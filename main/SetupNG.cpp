...
SetupNG<float>			kp_Mahony("KP Mahony", 0.15, true, SYNC_FROM_MASTER, PERSISTENT, change_kpMahony );
SetupNG<float>			ki_Mahony("KI Mahony", 0.0002, true, SYNC_FROM_MASTER, PERSISTENT, change_kiMahony );
SetupNG<float>			UiP_gain("UIPGAIN",1.1, true, SYNC_FROM_MASTER, PERSISTENT, change_UiPgain );
